            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="/admin/editgalerey"><i class="fa fa-dashboard fa-fw"></i> Изменить галерею</a>
                        </li>
						<li>
                            <a href="/admin/editgalerey2"><i class="fa fa-dashboard fa-fw"></i> Изменить галерею 2</a>
                        </li>
						
						<li>
                            <a href="/admin/news"><i class="fa fa-dashboard fa-fw"></i>Новости</a>
                        </li>
