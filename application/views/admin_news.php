                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									<p><a href="/admin/addnew/text">Добавить текстовою новость</a></p>
									<p><a href="/admin/addnew/video">Добавить видео новость</a></p>
									<p><a href="/admin/addnew/audio">Добавить аудио новость</a></p>
									<p><a href="/admin/addnew/chit">Добавить цитату</a></p>
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										{
											$title = ($new->type != 'chit') ? $new->title : $new->full_text;?>
											<tr class="odd gradeX">
												<td><?php echo $title ?></td>
												<td><a href="/admin/editnew/<?php echo $new->id ?>">Изменить</a></td>
												<td><a href="/admin/delnew/<?php echo $new->id ?>">Удалить</a></td>
											</tr>
										<?php } ?>
