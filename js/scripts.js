...
INKAS.modals = function(){
	...
	$('.un-list-share-top li#un-btn-search a, .un-btn-search').on( 'click', function(e){
		...
		$('body').append('<div id="un-search-modal" class="un-search-modal"><div class="un-search-close"><i class="un-icon-close"></i></div><form id="un-search-form" class="un-search-form" action="" method="get"><input type="textbox" placeholder="Поиск..." value="" id="un-search-field" class="un-search-field"><div class="un-search-row"></div></form></div>');
